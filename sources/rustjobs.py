...
Fetches Rust-specific jobs via RSS feed.
"""
...
RSS_URL = "https://rustjobs.dev/feed.xml"


class RustJobsSource(BaseJobSource):
    """Fetches Rust jobs from rustjobs.dev RSS."""
    ...
    async def fetch(self, client: httpx.AsyncClient) -> list[RawJob]:
        ...
        try:
            ...
            logger.info(f"[rustjobs] Fetched {len(feed.entries)} jobs")

        except Exception as e:
            logger.warning(f"[rustjobs] Failed: {e}")
